    ...
    return (
        <div className='services text-center'>
            ...
            <div className='d-flex justify-content-center mb-4 align-items-start'>
                <div className='service-icon'><i class="fas fa-shipping-fast"></i></div>
            ...
            <div className='d-flex  mb-4 align-items-center justify-content-center'>
                <div className='service-icon'><i class="fas fa-undo"></i></div>
                <div className='service-text'>
            ...
            <div className='d-flex justify-content-center mb-4 align-items-start'>
                <div className='service-icon'><i class="fas fa-info"></i></div>
                <div className='service-text'>
            ...
            <div className='d-flex justify-content-center mb-4 align-items-start'>
                <div className='service-icon'><i class="fas fa-life-ring"></i></div>
                <div className='service-text'>
